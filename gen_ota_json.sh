...
echo -e "New update - ${TAG}\n--------------------------------\n" > ~/OTAUpdates/release_notes.txt
nano ~/OTAUpdates/release_notes.txt

echo "Creating new release..."

gh release create ${TAG} --title ${TAG} -F ~/OTAUpdates/release_notes.txt /home/jenkins/workspace/LineageOS-18.1-olives/out/target/product/${DEVICE}/${FILENAME}
else
echo "! onlyjson mode"
